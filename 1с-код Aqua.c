...
Процедура Команда5НаСервере()
    ...
    Заголовки = Новый Соответствие;
    Заголовки.Вставить("X-API-KEY", "123");
	Заголовки.Вставить("X-COMPANY-SYS", "Aqua");
	Заголовки.Вставить("X-COMPANY-KEY", "Aqua1");
	Заголовки.Вставить("Content-Type", "application/json;");
    ...
    // Запись JSON
        ...
        |  *
        |ИЗ
        |  Документ.ПоступлениеОборудования"
    );
	...
	Пока ВыборкаДокументов.Следующий() Цикл
		...
		Док1С.Вставить("link0_Поставщик", Строка(ДокСырой.Поставщик.Ссылка.УникальныйИдентификатор()));
		Док1С.Вставить("Склад", Строка(ДокСырой.Склад));
		Док1С.Вставить("Оборудование", Строка(ДокСырой.Оборудование));
	...
	Коллекция.Вставить("name", "ПоступлениеОборудования");
	Коллекция.Вставить("link_name", "ПоступлениеОборудования");
